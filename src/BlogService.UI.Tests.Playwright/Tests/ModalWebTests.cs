...
[UsedImplicitly]
public class ModalFixture : PlaywrightPageFixture<IAppMarker>
{
...
[TestCaseOrderer(ordererTypeName: "BlogService.UI.Test.Playwright.PriorityOrderer", ordererAssemblyName: "BlogService.UI.Test.Playwright")]
public class ModalWebTests : IClassFixture<ModalFixture>
{
  ...
  public async Task CanLaunchModal()
  {
	...
	await Page.Locator("article").WaitForAsync(new() { Timeout = 30000 });
	...
	await Page.Locator("#contentModal").WaitForAsync(new() { Timeout = 30000 });
