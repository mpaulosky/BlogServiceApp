...
public class GivenBlogPostsComponent : TestContext
{
	...
	{
		var component = RenderComponent<BlogPosts>();
	...
	public void BlogPosts_With_Data_Should_DisplayPosts_Test()
	{
		...
		const string expected =
			...
			<div class="card my-4">
			  ...
			  <div class="card-body">
			    <h5 diff:ignore>Assumenda iste quia natus et dignissimos reiciendis ad nostrum totam.</h5>
			    <p diff:ignore>Voluptatibus doloremque eos asperiores cum ipsam. Pariatur doloribus aperiam cumque non recusandae est unde vitae. Qui exercitationem doloribus facilis.</p>
			    <p class="card-text">
			...
			<div class="card my-4">
			  ...
			  <div class="card-body">
			    <h5 diff:ignore>Omnis fugiat facere labore quia quia dolor in qui eum.</h5>
			    <p diff:ignore>Quae minima atque ex est esse.</p>
			    <p class="card-text">
			...
			<div class="card my-4">
			  ...
			  <div class="card-body">
			    <h5 diff:ignore>Molestiae aut omnis modi labore et consectetur qui at numquam.</h5>
			    <p diff:ignore>Nesciunt dicta dolores nam occaecati deleniti. Distinctio incidunt libero quia debitis autem sequi provident quasi veniam. Et autem porro qui unde dolores dolorem atque sunt sit. Accusamus facilis corporis laboriosam ut molestiae alias.</p>
			    <p class="card-text">
